...
(function () {
  ...
  add('/ hó · ÁFÁ-val', '/ Monat · inkl. MwSt.', '/ mo · incl. VAT');
  ...
  add('Szaknévsor PRO', 'Branchenbuch PRO', 'Directory PRO');
  add('Kiemelt Állás', 'Hervorgehobene Stelle', 'Featured Job');
  ...
  add('/ hirdetés · egyszeri, ÁFÁ-val', '/ Anzeige · einmalig, inkl. MwSt.', '/ listing · one-time, incl. VAT');
  ...
  add('A keresés, a profilok böngészése és a hívás ingyenes marad. Ha mélyebbre mennél — vagy magyar ügyfeleket, munkaerőt szereznél — itt vannak az opcionális prémium csomagok. A feltüntetett árak tartalmazzák az ÁFÁ-t; a pontos, országodra lokalizált végösszeget a pénztár és a kinti.app/pro oldal mutatja. A fizetést a Paddle (Merchant of Record) bonyolítja; ha a Kinti Android-alkalmazásból vásárolsz, ott a Google Play fizetési rendszere érvényes.A fizetést a Google Play fizetési rendszere bonyolítja.',
    'Suche, das Durchstöbern von Profilen und Anrufe bleiben kostenlos. Wenn du tiefer einsteigen — oder ungarische Kunden und Arbeitskräfte gewinnen — möchtest, findest du hier die optionalen Premium-Pakete. Die angegebenen Preise <strong>enthalten die MwSt.</strong>; den genauen, für dein Land lokalisierten Endbetrag zeigen die Kasse und die Seite <a href="/pro" style="color: inherit; text-decoration: underline;">kinti.app/pro</a>. <span class="web-only-payment">Die Zahlung wickelt <strong>Paddle</strong> (Merchant of Record) ab; kaufst du aus der Kinti-<strong>Android-App</strong>, gilt dort das Zahlungssystem von <strong>Google Play</strong>.</span><span class="android-only-payment">Die Zahlung wickelt das Zahlungssystem von <strong>Google Play</strong> ab.</span>',
    'Search, browsing profiles and calling stay free. If you want to go deeper — or win Hungarian clients or workers — the optional premium plans are here. The listed prices <strong>include VAT</strong>; the exact final amount for your country is shown at checkout and at <a href="/pro" style="color: inherit; text-decoration: underline;">kinti.app/pro</a>. <span class="web-only-payment">Payment is handled by <strong>Paddle</strong> (Merchant of Record); if you buy from the Kinti <strong>Android app</strong>, <strong>Google Play</strong>’s payment system applies.</span><span class="android-only-payment">Payment is handled by <strong>Google Play</strong>’s payment system.</span>');
