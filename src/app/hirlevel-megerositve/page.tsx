...
export default function HirlevelMegerositvePage({
  ...
  if (status === "unsubscribed") {
    ...
    message = "Kész — mostantól hetente egyszer küldjük az új eseményeket és hirdetéseket a választott kantonból. Bármikor leiratkozhatsz az emailek alján található linkkel.";
  }
