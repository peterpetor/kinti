...
export const metadata = { title: "Bejelentkezés" };
...
/**
 * Bejelentkezés — BEÁGYAZOTT Clerk <SignIn> (magyar a ClerkProvider `huHU`
 * localizációjával). A clerkMiddleware kezeli a session-handshake-et a custom
 * domainen. (Korábban a hosztolt accounts.kinti.app portál volt itt — az angol;
 * a beágyazott a magyar, on-brand.)
 */
