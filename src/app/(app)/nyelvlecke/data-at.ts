...
export const LESSONS_AT: Lesson[] = [
  ...
  {
    id: "al2", title: "Búcsúzás", description: "Baba, Pfiat di — elköszönés osztrák módra.", chapter: 1, xpReward: 10,
    questions: [
      { id: "q4", type: "multiple_choice", prompt: "Informális 'szia' (búcsúzáskor)?", options: [{ id: "o1", text: "Baba" }, { id: "o2", text: "Ciao bella" }, { id: "o3", text: "Hi" }], correctOptionId: "o1" },
      { id: "q5", type: "flashcard", prompt: "'Viszlát' (informális, regionális)?", backText: "Pfiat di", phonetic: "Pfíjat di" },
      { id: "q6", type: "match", prompt: "Párosítsd a búcsúzásokat!", pairs: [{ id: "p1", left: "Szia (búcsú)", right: "Baba" }, { id: "p2", left: "Viszlát", right: "Pfiat di" }, { id: "p3", left: "Viszontlátásra (hiv.)", right: "Auf Wiederschauen" }] },
    ],
  },
  {
