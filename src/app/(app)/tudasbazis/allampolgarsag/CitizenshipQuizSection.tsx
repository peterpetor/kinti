    ...
    <div className="pt-8 border-t border-line">
      ...
      {isPro ? (
        ...
        <div className="rounded-card border-2 border-star/30 bg-star/5 p-5 text-center">
          ...
          <Link
            href="/pro"
            className="mt-4 inline-flex items-center justify-center rounded-pill bg-star px-5 py-2.5 text-[14px] font-extrabold text-on-pro transition hover:bg-[#d68f20] active:scale-[0.98]"
          >
            Kinti PRO feloldása
          </Link>
        </div>
