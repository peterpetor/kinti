...
const FEATURES: Record<LegalLang, AiFeature[]> = {
  hu: [
    ...
    },
    {
      ...
      what: "A napi szó kiejtését a KÉSZÜLÉKED saját beszédszintézise mondja ki (a böngészőbe épített Web Speech API). Se a szó, se hangfelvétel NEM kerül a szervereinkre, és nem használunk hozzá AI-modellt.",
      model: "A böngésző/operációs rendszer beépített beszédszintézise — nem a mi AI-modellünk",
      limits: "A gépi kiejtés közelítő — az anyanyelvi kiejtés eltérhet. Régi böngészőben a gomb el sem érhető.",
    },
  ],
  de: [
    {
    ...
    },
    {
      ...
      what: "Die Aussprache des Worts des Tages wird von der Sprachsynthese DEINES GERÄTS erzeugt (die im Browser eingebaute Web Speech API). Weder das Wort noch eine Audioaufnahme gelangt auf unsere Server, und es kommt kein KI-Modell zum Einsatz.",
      model: "Eingebaute Sprachsynthese des Browsers/Betriebssystems — kein KI-Modell von uns",
      limits: "Die maschinelle Aussprache ist eine Annäherung — die Aussprache von Muttersprachlern kann abweichen. In älteren Browsern ist die Schaltfläche nicht verfügbar.",
    },
  ],
  en: [
    {
    ...
    },
    {
      ...
      what: "The pronunciation of the word of the day is spoken by YOUR DEVICE's own speech synthesis (the Web Speech API built into the browser). Neither the word nor any audio recording reaches our servers, and no AI model is involved.",
      model: "Built-in speech synthesis of the browser/operating system — not an AI model of ours",
      limits: "Machine pronunciation is approximate — native pronunciation may differ. On older browsers the button is not available at all.",
    },
  ],
};
