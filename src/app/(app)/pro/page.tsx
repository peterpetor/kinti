...
const T: Record<LegalLang, {
  ...
  hu: {
    ...
    netPriceStatic: "Tájékoztató ár, ÁFÁ-val együtt — a pontos végösszeget a pénztár mutatja. Havonta automatikusan megújul, bármikor lemondható.",
    ...
    netPriceStaticJob: "Tájékoztató ár, ÁFÁ-val együtt — a pontos végösszeget a pénztár mutatja. Egyszeri díj: a kiemelés 30 napig él, NEM újul meg automatikusan.",
  ...
  de: {
    ...
    netPriceStatic: "Richtpreis inkl. MwSt. — den genauen Endbetrag zeigt die Kasse. Verlängert sich monatlich automatisch, jederzeit kündbar.",
    ...
    netPriceStaticJob: "Richtpreis inkl. MwSt. — den genauen Endbetrag zeigt die Kasse. Einmalige Gebühr: die Hervorhebung gilt 30 Tage und verlängert sich NICHT automatisch.",
  ...
  en: {
    ...
    netPriceStatic: "Indicative price incl. VAT — the exact final amount is shown at checkout. Renews automatically each month, cancel anytime.",
    ...
    netPriceStaticJob: "Indicative price incl. VAT — the exact final amount is shown at checkout. One-time fee: the highlight is valid for 30 days and does NOT renew automatically.",
