...
const T: Record<LegalLang, {
  ...
  hu: {
    ...
    perMonth: " / hó",
    netPriceLive: "Az ár tartalmazza az ÁFÁ-t (az országod kulcsa szerint). Havonta automatikusan megújul, bármikor lemondható.",
    netPriceStatic: "Tájékoztató ár — a pontos, adóval együttes végösszeget a pénztár mutatja. Havonta automatikusan megújul, bármikor lemondható.",
    ...
    notPurchasable: "Ebből az országból az előfizetés még nem indítható. Addig is minden ingyenes funkció elérhető.",
    ...
    perListing: " / hirdetés",
    netPriceLiveJob: "Az ár tartalmazza az ÁFÁ-t (az országod kulcsa szerint). Egyszeri díj: a kiemelés 30 napig él, NEM újul meg automatikusan.",
    netPriceStaticJob: "Tájékoztató ár — a pontos, adóval együttes végösszeget a pénztár mutatja. Egyszeri díj: a kiemelés 30 napig él, NEM újul meg automatikusan.",
  ...
  de: {
    ...
    perMonth: " / Monat",
    netPriceLive: "Preis inkl. MwSt. (nach dem Satz deines Landes). Verlängert sich monatlich automatisch, jederzeit kündbar.",
    netPriceStatic: "Richtpreis — den genauen Endbetrag inkl. Steuer zeigt die Kasse. Verlängert sich monatlich automatisch, jederzeit kündbar.",
    ...
    notPurchasable: "Aus diesem Land kann das Abo noch nicht gestartet werden. Alle kostenlosen Funktionen bleiben verfügbar.",
    ...
    perListing: " / Anzeige",
    netPriceLiveJob: "Preis inkl. MwSt. (nach dem Satz deines Landes). Einmalige Gebühr: die Hervorhebung gilt 30 Tage und verlängert sich NICHT automatisch.",
    netPriceStaticJob: "Richtpreis — den genauen Endbetrag inkl. Steuer zeigt die Kasse. Einmalige Gebühr: die Hervorhebung gilt 30 Tage und verlängert sich NICHT automatisch.",
  ...
  en: {
    ...
    perMonth: " / month",
    netPriceLive: "Price includes VAT (at your country's rate). Renews automatically each month, cancel anytime.",
    netPriceStatic: "Indicative price — the exact final amount incl. tax is shown at checkout. Renews automatically each month, cancel anytime.",
    ...
    notPurchasable: "Subscriptions can't be started from this country yet. All free features stay available.",
    ...
    perListing: " / listing",
    netPriceLiveJob: "Price includes VAT (at your country's rate). One-time fee: the highlight is valid for 30 days and does NOT renew automatically.",
    netPriceStaticJob: "Indicative price — the exact final amount incl. tax is shown at checkout. One-time fee: the highlight is valid for 30 days and does NOT renew automatically.",
...
export default function ProPage() {
  ...
  // Van-e egyáltalán élő Paddle-ár ehhez az országhoz? (2026-07-29 óta MIND az
  // 5 app-országhoz van — a GB-ár is elkészült. Az ág védőhálóként marad: egy
  // új app-ország ár nélkül ne a kattintás UTÁN fusson falba.)
