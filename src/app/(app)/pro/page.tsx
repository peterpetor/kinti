...
const COUNTRY_IN: Record<LegalLang, Record<string, string>> = {
  hu: { CH: "Svájcban", AT: "Ausztriában", DE: "Németországban", NL: "Hollandiában" },
  de: { CH: "in der Schweiz", AT: "in Österreich", DE: "in Deutschland", NL: "in den Niederlanden" },
  en: { CH: "in Switzerland", AT: "in Austria", DE: "in Germany", NL: "in the Netherlands" },
};
...
const PRO_FEATURES: Record<LegalLang, string[]> = {
  ...
  de: [
    ...
    "Einbürgerungstest-Simulator — für alle 4 Länder",
    "Kontaktaufnahme in der Zimmer-/Wohnungsbörse — Kontaktdaten der Inserenten einsehen",
    "Fach-Schnellwörterbuch — Fachbegriffe in Lektionen, mit Aussprache (alle 4 Länder)",
  ],
  en: [
    ...
    "Citizenship test simulator — for all 4 countries",
    "Room/flat marketplace contact — unlock listers' contact details",
    "Professional quick dictionary — industry terms in lessons, with pronunciation (all 4 countries)",
  ],
};
...
const T: Record<LegalLang, {
  ...
  hu: {
    ...
    userDesc: "Magánszemélyeknek. AI-asszisztens, prémium modulok és kalkulátorok — egy havidíjért, mind a 4 országra 🇨🇭 🇦🇹 🇩🇪 🇳🇱.",
    perMonth: " / hó",
    ...
    bizDesc: "Vállalkozóknak és szakembereknek. Szerezz több ügyfelet prémium láthatósággal — a Szaknévsor mind a 4 országban él 🇨🇭 🇦🇹 🇩🇪 🇳🇱.",
    ...
    jobDesc: "Munkáltatóknak. Találj gyorsabban megbízható magyar munkaerőt — hirdetés a 4 ország magyar közösségének 🇨🇭 🇦🇹 🇩🇪 🇳🇱.",
    perListing: " / hirdetés",
  ...
  de: {
    ...
    userDesc: "Für Privatpersonen. KI-Assistent, Premium-Module und Rechner — für eine monatliche Gebühr, für alle 4 Länder 🇨🇭 🇦🇹 🇩🇪 🇳🇱.",
    perMonth: " / Monat",
    ...
    bizDesc: "Für Unternehmer und Fachkräfte. Gewinne mehr Kunden mit Premium-Sichtbarkeit — das Branchenbuch ist in allen 4 Ländern aktiv 🇨🇭 🇦🇹 🇩🇪 🇳🇱.",
    ...
    jobDesc: "Für Arbeitgeber. Finde schneller verlässliche ungarische Arbeitskräfte — Anzeige für die ungarische Community in 4 Ländern 🇨🇭 🇦🇹 🇩🇪 🇳🇱.",
    perListing: " / Anzeige",
  ...
  en: {
    ...
    userDesc: "For individuals. AI assistant, premium modules, and calculators — for one monthly fee, across all 4 countries 🇨🇭 🇦🇹 🇩🇪 🇳🇱.",
    perMonth: " / month",
    ...
    bizDesc: "For businesses and professionals. Win more customers with premium visibility — the Directory is live in all 4 countries 🇨🇭 🇦🇹 🇩🇪 🇳🇱.",
    ...
    jobDesc: "For employers. Find reliable Hungarian workers faster — your listing reaches the Hungarian community in 4 countries 🇨🇭 🇦🇹 🇩🇪 🇳🇱.",
    perListing: " / listing",
