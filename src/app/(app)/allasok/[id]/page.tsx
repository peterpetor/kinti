      ...
      {pro ? (
        ...
        >
          ...
          <span className="min-w-0 flex-1 text-[13px] leading-snug text-ink">
            <strong className="text-pro-ink">Kinti PRO:</strong> lásd, hány %-ban illik ez az állás a profilodhoz, és a becsült <strong>nettó bért</strong> a régiódban. <span className="text-ink-muted">(Ez a Kinti PRO álláskereső funkciója — <strong>nem</strong> a Szaknévsor PRO, amit a vállalkozásodhoz vehetsz.)</span>
          </span>
          <Icon name="chevR" size={16} strokeWidth={2.4} className="shrink-0 text-pro-ink" />
        </Link>
      )}
