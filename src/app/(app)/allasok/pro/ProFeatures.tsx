 ...
 * tényleg létező elemeket mutatja (szakmai szótár CH-only, állampolgársági teszt mind a 6 országra).
 */
export function ProFeatures() {
  ...
  // A nyelvkurzus 2026-07-11 óta INGYENES mind a 6 országban (user-döntés) —
  ...
  items.push({ title: "Állampolgársági teszt-szimulátor", desc: "Vizsga-szimuláció a saját országod kérdéssorával — mind a 6 országra." });
