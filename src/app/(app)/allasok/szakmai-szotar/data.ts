...
export const INDUSTRY_LESSONS: Lesson[] = [
...

  {
    ...
    description: "Munkavédelem és anyagok — mélyebb szókincs a svájci építkezésen.",
    industry: "Építőipar (Baubranche)",
    xpReward: 20,
    isPro: true,
    questions: [
      ...
      },
      {
        id: "bau2_q4",
        type: "flashcard",
        prompt: "Kérek egy zsák cementet.",
        backText: "Ich bruch en Sack Zement.",
        phonetic: "Ih brúh en zák ce-ment.",
      },
      {
        id: "bau2_q5",
        type: "match",
        prompt: "Párosítsd az anyagokat és felszereléseket!",
        pairs: [
          { id: "p1", left: "Tégla", right: "Ziegel" },
          { id: "p2", left: "Vakolat", right: "Verputz" },
          { id: "p3", left: "Munkavédelmi cipő", right: "Sicherheitsschuhe" },
          { id: "p4", left: "Betonkeverő", right: "Betonmischer" },
        ],
      },
    ],
  },
...

  {
    ...
    description: "Allergiák, különleges kérések — mélyebb szókincs a svájci vendéglátásban.",
    industry: "Vendéglátás (Gastronomie)",
    xpReward: 20,
    isPro: true,
    questions: [
      ...
      },
      {
        ...
        type: "flashcard",
        prompt: "Vegetáriánus",
        backText: "Vegetarisch",
        phonetic: "Ve-ge-tá-ris",
      },
      {
        id: "gas2_q3",
        type: "multiple_choice",
      ...
      },
      {
        id: "gas2_q4",
        type: "flashcard",
        prompt: "Van gluténmentes opció?",
        backText: "Gits öppis Glutenfreis?",
        phonetic: "Gits öp-pisz glu-ten-frájsz?",
      },
      {
        id: "gas2_q5",
        type: "match",
        prompt: "Párosítsd a vendéglátós szavakat!",
        pairs: [
          { id: "p1", left: "Panasz", right: "Beschwerde" },
          { id: "p2", left: "Külön számla", right: "Getrennte Rechnung" },
          { id: "p3", left: "Vegán", right: "Vegan" },
          { id: "p4", left: "Adag", right: "Portion" },
        ],
      },
    ],
  },
  ...
  {
    id: "pflege_2",
    title: "Ápolás és Egészségügy 2.",
    description: "Vitális jelek és mobilizálás — mélyebb szókincs az idősgondozásban.",
    industry: "Egészségügy (Gesundheitswesen)",
    xpReward: 20,
    isPro: true,
    questions: [
      ...
      },
      {
        ...
        prompt: "Hőmérséklet",
        backText: "Temperatur",
        phonetic: "Tem-pe-rá-túr",
      },
      {
        id: "pfl2_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Medikamentenplan'?",
        options: [
          { id: "a", text: "Gyógyszeradagolási terv" },
          { id: "b", text: "Étrend" },
          { id: "c", text: "Kórtörténet" },
        ],
        correctOptionId: "a",
      },
      {
        id: "pfl2_q4",
        type: "flashcard",
        prompt: "Segítek felkelni.",
        backText: "Ich hilf Ihne ufstoh.",
        phonetic: "Ih hilf í-ne uf-stó.",
      },
      {
        id: "pfl2_q5",
        type: "match",
        prompt: "Párosítsd az ápolási szavakat!",
        pairs: [
          { id: "p1", left: "Testápolás", right: "Körperpflege" },
          { id: "p2", left: "Ágytál", right: "Bettpfanne" },
          { id: "p3", left: "Vérnyomásmérő", right: "Blutdruckmessgerät" },
          { id: "p4", left: "Kórterem", right: "Krankenzimmer" },
        ],
      },
    ],
  },
  ...
  // ── 16. Élelmiszeripar (Bäckerei) ─────────────────────────────────
  {
    id: "back_1",
    title: "Pékség Alapok 1.",
    description: "Alapvető kifejezések egy svájci pékségben.",
    ...
    questions: [
      ...
      },
      {
        ...
        type: "flashcard",
        prompt: "Croissant",
        backText: "Gipfeli (svájci szó — Németországban/Ausztriában: Croissant)",
        phonetic: "Gip-fe-li",
      },
      {
        id: "back_q3",
        type: "multiple_choice",
        prompt: "Mit jelent az 'Ofen'?",
        options: [
          { id: "a", text: "Sütő" },
          { id: "b", text: "Liszt" },
          { id: "c", text: "Tészta" },
      ...
      },
      {
        id: "back_q4",
        type: "flashcard",
        prompt: "Friss még meleg a kenyér?",
        backText: "Isch s'Brot no warm?",
        phonetic: "Is szbrót nó várm?",
      },
      {
        id: "back_q5",
        type: "match",
        prompt: "Párosítsd a pékségi szavakat!",
        pairs: [
          { id: "p1", left: "Kenyér", right: "Brot" },
          { id: "p2", left: "Liszt", right: "Mehl" },
          { id: "p3", left: "Zsemle", right: "Brötchen" },
          { id: "p4", left: "Süteménytészta", right: "Kuchenteig" },
        ],
      },
    ],
  },

  // ── 17. Villanyszerelés (Elektriker) ──────────────────────────────
  {
    id: "elek_1",
    title: "Villanyszerelő Alapok 1.",
    description: "Alapvető kifejezések villanyszerelőként Svájcban.",
    ...
    questions: [
      ...
      },
      {
        id: "elek_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Steckdose'?",
        options: [
          { id: "a", text: "Konnektor" },
          { id: "b", text: "Kábel" },
          { id: "c", text: "Biztosíték" },
        ],
        correctOptionId: "a",
      },
      {
        id: "elek_q4",
        type: "flashcard",
        prompt: "Kapcsold le az áramot!",
        backText: "Schalt de Strom us!",
        phonetic: "Sált de strom usz!",
      },
      {
        id: "elek_q5",
        type: "match",
        prompt: "Párosítsd a villanyszerelős szavakat!",
        pairs: [
          { id: "p1", left: "Áramütés", right: "Stromschlag" },
          { id: "p2", left: "Szerelés", right: "Installation" },
          { id: "p3", left: "Villanyszerelő", right: "Elektriker" },
          { id: "p4", left: "Kapcsoló", right: "Schalter" },
        ],
      },
    ],
  },

  // ── 18. Kozmetika (Kosmetik) ──────────────────────────────────────
  {
    id: "kosm_1",
    title: "Kozmetika Alapok 1.",
    description: "Alapvető kifejezések manikűrösként vagy kozmetikusként Svájcban.",
    ...
    questions: [
      ...
      },
      {
        id: "kosm_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Gesichtsbehandlung'?",
        options: [
          { id: "a", text: "Arckezelés" },
          { id: "b", text: "Szemöldökszedés" },
          { id: "c", text: "Pedikűr" },
        ],
        correctOptionId: "a",
      },
      {
        id: "kosm_q4",
        type: "flashcard",
        prompt: "Milyen színt szeretne?",
        backText: "Weles Farb möchted Sie?",
        phonetic: "Vé-les fárb möh-ted zí?",
      },
      {
        id: "kosm_q5",
        type: "match",
        ...
        pairs: [
          { id: "p1", left: "Műköröm", right: "Kunstnägel" },
          { id: "p2", left: "Szemöldökszedés", right: "Augenbrauenzupfen" },
          { id: "p3", left: "Pedikűr", right: "Pediküre" },
          { id: "p4", left: "Szempillafestés", right: "Wimpernfärben" },
        ],
      },
    ],
  },

  // ── 19. Vízvezeték-szerelés (Installateur) ────────────────────────
  {
    id: "instal_1",
    title: "Vízvezeték-szerelő Alapok 1.",
    description: "Alapvető kifejezések vízvezeték-szerelőként Svájcban.",
    ...
    questions: [
      ...
      },
      {
        id: "instal_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Verstopfung'?",
        options: [
          { id: "a", text: "Dugulás" },
          { id: "b", text: "Szivárgás" },
          { id: "c", text: "Fűtés" },
      ...
      },
      {
        id: "instal_q4",
        type: "flashcard",
        prompt: "Honnan szivárog a víz?",
        backText: "Wo lauft's Wasser use?",
        phonetic: "Vó láuftsz vász-szer u-ze?",
      },
      {
        id: "instal_q5",
        type: "match",
        prompt: "Párosítsd a szerelős szavakat!",
        pairs: [
          { id: "p1", left: "Szivárgás", right: "Leck" },
          { id: "p2", left: "Fűtés", right: "Heizung" },
          { id: "p3", left: "Vízóra", right: "Wasserzähler" },
          { id: "p4", left: "Lefolyó", right: "Abfluss" },
        ],
      },
    ],
  },
...
export const INDUSTRY_LESSONS_AT: Lesson[] = [
  ...
  },
  {
    id: "at_bau_2",
    title: "Építőipari Alapok 2.",
    description: "Munkavédelem és anyagok — mélyebb szókincs az osztrák építkezésen.",
    industry: "Építőipar (Baubranche)",
    xpReward: 20,
    isPro: true,
    lang: "de-AT",
    questions: [
      { id: "at_bau2_q1", type: "flashcard", prompt: "Sisak", backText: "Helm", phonetic: "Helm" },
      { id: "at_bau2_q2", type: "flashcard", prompt: "Állvány", backText: "Gerüst", phonetic: "Ge-rüszt" },
      {
        id: "at_bau2_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Beton'?",
      ...
      { id: "at_bau2_q4", type: "flashcard", prompt: "Kérek egy zsák cementet.", backText: "Ich brauche einen Sack Zement.", phonetic: "Ih bráu-he áj-nen zák ce-ment." },
      {
        id: "at_bau2_q5",
        type: "match",
        prompt: "Párosítsd az anyagokat és felszereléseket!",
  ...
  },
  {
    id: "at_gastro_2",
    title: "Vendéglátás Alapok 2.",
    description: "Allergiák, különleges kérések — mélyebb szókincs az osztrák vendéglátásban.",
    industry: "Vendéglátás (Gastronomie)",
    xpReward: 20,
    isPro: true,
    lang: "de-AT",
    questions: [
      { id: "at_gas2_q1", type: "flashcard", prompt: "Allergia", backText: "Allergie", phonetic: "Á-ler-gí" },
      { id: "at_gas2_q2", type: "flashcard", prompt: "Vegetáriánus", backText: "Vegetarisch", phonetic: "Ve-ge-tá-ris" },
      {
        id: "at_gas2_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Reservierung'?",
      ...
      { id: "at_gas2_q4", type: "flashcard", prompt: "Van gluténmentes opció?", backText: "Gibt es etwas Glutenfreies?", phonetic: "Gipt esz et-vász glu-ten-frá-jesz?" },
      {
        id: "at_gas2_q5",
        type: "match",
        prompt: "Párosítsd a vendéglátós szavakat!",
  ...
  },
  {
    ...
    lang: "de-AT",
    questions: [
      { id: "at_pfl2_q1", type: "flashcard", prompt: "Vérnyomás", backText: "Blutdruck", phonetic: "Blút-druk" },
      { id: "at_pfl2_q2", type: "flashcard", prompt: "Hőmérséklet", backText: "Temperatur", phonetic: "Tem-pe-rá-túr" },
      {
        id: "at_pfl2_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Medikamentenplan'?",
      ...
      { id: "at_pfl2_q4", type: "flashcard", prompt: "Segítek felkelni.", backText: "Ich helfe Ihnen aufzustehen.", phonetic: "Ih hel-fe í-nen áuf-cu-sté-en." },
      {
        id: "at_pfl2_q5",
        type: "match",
        prompt: "Párosítsd az ápolási szavakat!",
  ...
  },
  {
    id: "at_back_1",
    title: "Pékség Alapok 1.",
    description: "Alapvető kifejezések egy osztrák pékségben.",
    industry: "Élelmiszeripar (Bäckerei)",
    xpReward: 15,
    isPro: true,
    lang: "de-AT",
    questions: [
      { id: "at_back_q1", type: "flashcard", prompt: "Tészta", backText: "Teig", phonetic: "Tájg" },
      { id: "at_back_q2", type: "flashcard", prompt: "Zsemle", backText: "Semmel (osztrák szó — Németországban/Svájcban: Brötchen)", phonetic: "Zem-mel" },
      {
        id: "at_back_q3",
        type: "multiple_choice",
        prompt: "Mit jelent az 'Ofen'?",
      ...
      { id: "at_back_q4", type: "flashcard", prompt: "Friss még meleg a kenyér?", backText: "Ist das Brot noch warm?", phonetic: "Iszt dász brót noh várm?" },
      {
        id: "at_back_q5",
        type: "match",
        prompt: "Párosítsd a pékségi szavakat!",
        pairs: [
          { id: "p1", left: "Kenyér", right: "Brot" },
          { id: "p2", left: "Liszt", right: "Mehl" },
          { id: "p3", left: "Croissant", right: "Kipferl" },
          { id: "p4", left: "Süteménytészta", right: "Kuchenteig" },
        ],
      },
    ],
  },
  {
    id: "at_elek_1",
    title: "Villanyszerelő Alapok 1.",
    description: "Alapvető kifejezések villanyszerelőként Ausztriában.",
    industry: "Villanyszerelés (Elektriker)",
    xpReward: 15,
    isPro: true,
    lang: "de-AT",
    questions: [
      { id: "at_elek_q1", type: "flashcard", prompt: "Kábel", backText: "Kabel", phonetic: "Ká-bel" },
      { id: "at_elek_q2", type: "flashcard", prompt: "Biztosíték", backText: "Sicherung", phonetic: "Zi-he-rung" },
      {
        id: "at_elek_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Steckdose'?",
      ...
      { id: "at_elek_q4", type: "flashcard", prompt: "Kapcsold le az áramot!", backText: "Schalte den Strom aus!", phonetic: "Sál-te den strom aus!" },
      {
        id: "at_elek_q5",
        type: "match",
        prompt: "Párosítsd a villanyszerelős szavakat!",
  ...
  },
  {
    id: "at_kosm_1",
    title: "Kozmetika Alapok 1.",
    description: "Alapvető kifejezések manikűrösként vagy kozmetikusként Ausztriában.",
    industry: "Kozmetika (Kosmetik)",
    xpReward: 15,
    isPro: true,
    lang: "de-AT",
    questions: [
      { id: "at_kosm_q1", type: "flashcard", prompt: "Manikűr", backText: "Maniküre", phonetic: "Má-ní-kü-re" },
      { id: "at_kosm_q2", type: "flashcard", prompt: "Körömlakk", backText: "Nagellack", phonetic: "Ná-gel-lak" },
      {
        id: "at_kosm_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Gesichtsbehandlung'?",
      ...
      { id: "at_kosm_q4", type: "flashcard", prompt: "Milyen színt szeretne?", backText: "Welche Farbe möchten Sie?", phonetic: "Vel-he fár-be möh-ten zí?" },
      {
        id: "at_kosm_q5",
        type: "match",
        prompt: "Párosítsd a kozmetikai szavakat!",
  ...
  },
  {
    id: "at_instal_1",
    title: "Vízvezeték-szerelő Alapok 1.",
    description: "Alapvető kifejezések vízvezeték-szerelőként Ausztriában.",
    industry: "Vízvezeték-szerelés (Installateur)",
    xpReward: 15,
    isPro: true,
    lang: "de-AT",
    questions: [
      { id: "at_instal_q1", type: "flashcard", prompt: "Csap", backText: "Wasserhahn", phonetic: "Vász-szer-hán" },
      { id: "at_instal_q2", type: "flashcard", prompt: "Cső", backText: "Rohr", phonetic: "Rór" },
      {
        id: "at_instal_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Verstopfung'?",
      ...
      { id: "at_instal_q4", type: "flashcard", prompt: "Honnan szivárog a víz?", backText: "Wo läuft das Wasser aus?", phonetic: "Vó lőft dász vász-szer áusz?" },
      {
        id: "at_instal_q5",
        type: "match",
        prompt: "Párosítsd a szerelős szavakat!",
...
export const INDUSTRY_LESSONS_DE: Lesson[] = [
  ...
  },
  {
    id: "de_bau_2",
    title: "Építőipari Alapok 2.",
    description: "Munkavédelem és anyagok — mélyebb szókincs a német építkezésen.",
    industry: "Építőipar (Baubranche)",
    xpReward: 20,
    isPro: true,
    lang: "de-DE",
    questions: [
      { id: "de_bau2_q1", type: "flashcard", prompt: "Sisak", backText: "Helm", phonetic: "Helm" },
      { id: "de_bau2_q2", type: "flashcard", prompt: "Állvány", backText: "Gerüst", phonetic: "Ge-rüszt" },
      {
        id: "de_bau2_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Beton'?",
      ...
      { id: "de_bau2_q4", type: "flashcard", prompt: "Kérek egy zsák cementet.", backText: "Ich brauche einen Sack Zement.", phonetic: "Ih bráu-he áj-nen zák ce-ment." },
      {
        id: "de_bau2_q5",
        type: "match",
        prompt: "Párosítsd az anyagokat és felszereléseket!",
  ...
  },
  {
    id: "de_gastro_2",
    title: "Vendéglátás Alapok 2.",
    description: "Allergiák, különleges kérések — mélyebb szókincs a német vendéglátásban.",
    industry: "Vendéglátás (Gastronomie)",
    xpReward: 20,
    isPro: true,
    lang: "de-DE",
    questions: [
      { id: "de_gas2_q1", type: "flashcard", prompt: "Allergia", backText: "Allergie", phonetic: "Á-ler-gí" },
      { id: "de_gas2_q2", type: "flashcard", prompt: "Vegetáriánus", backText: "Vegetarisch", phonetic: "Ve-ge-tá-ris" },
      {
        id: "de_gas2_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Reservierung'?",
      ...
      { id: "de_gas2_q4", type: "flashcard", prompt: "Van gluténmentes opció?", backText: "Gibt es etwas Glutenfreies?", phonetic: "Gipt esz et-vász glu-ten-frá-jesz?" },
      {
        id: "de_gas2_q5",
        type: "match",
        prompt: "Párosítsd a vendéglátós szavakat!",
  ...
  },
  {
    ...
    lang: "de-DE",
    questions: [
      { id: "de_pfl2_q1", type: "flashcard", prompt: "Vérnyomás", backText: "Blutdruck", phonetic: "Blút-druk" },
      { id: "de_pfl2_q2", type: "flashcard", prompt: "Hőmérséklet", backText: "Temperatur", phonetic: "Tem-pe-rá-túr" },
      {
        id: "de_pfl2_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Medikamentenplan'?",
      ...
      { id: "de_pfl2_q4", type: "flashcard", prompt: "Segítek felkelni.", backText: "Ich helfe Ihnen aufzustehen.", phonetic: "Ih hel-fe í-nen áuf-cu-sté-en." },
      {
        id: "de_pfl2_q5",
        type: "match",
        prompt: "Párosítsd az ápolási szavakat!",
  ...
  },
  {
    id: "de_back_1",
    title: "Pékség Alapok 1.",
    description: "Alapvető kifejezések egy német pékségben.",
    industry: "Élelmiszeripar (Bäckerei)",
    xpReward: 15,
    isPro: true,
    lang: "de-DE",
    questions: [
      { id: "de_back_q1", type: "flashcard", prompt: "Tészta", backText: "Teig", phonetic: "Tájg" },
      { id: "de_back_q2", type: "flashcard", prompt: "Zsemle", backText: "Brötchen", phonetic: "Brőt-hen" },
      {
        id: "de_back_q3",
        type: "multiple_choice",
        prompt: "Mit jelent az 'Ofen'?",
      ...
      { id: "de_back_q4", type: "flashcard", prompt: "Friss még meleg a kenyér?", backText: "Ist das Brot noch warm?", phonetic: "Iszt dász brót noh várm?" },
      {
        id: "de_back_q5",
        type: "match",
        prompt: "Párosítsd a pékségi szavakat!",
        pairs: [
          { id: "p1", left: "Kenyér", right: "Brot" },
          { id: "p2", left: "Liszt", right: "Mehl" },
          { id: "p3", left: "Croissant", right: "Croissant" },
          { id: "p4", left: "Süteménytészta", right: "Kuchenteig" },
        ],
      },
    ],
  },
  {
    id: "de_elek_1",
    title: "Villanyszerelő Alapok 1.",
    description: "Alapvető kifejezések villanyszerelőként Németországban.",
    industry: "Villanyszerelés (Elektriker)",
    xpReward: 15,
    isPro: true,
    lang: "de-DE",
    questions: [
      { id: "de_elek_q1", type: "flashcard", prompt: "Kábel", backText: "Kabel", phonetic: "Ká-bel" },
      { id: "de_elek_q2", type: "flashcard", prompt: "Biztosíték", backText: "Sicherung", phonetic: "Zi-he-rung" },
      {
        id: "de_elek_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Steckdose'?",
      ...
      { id: "de_elek_q4", type: "flashcard", prompt: "Kapcsold le az áramot!", backText: "Schalte den Strom aus!", phonetic: "Sál-te den strom aus!" },
      {
        id: "de_elek_q5",
        type: "match",
        prompt: "Párosítsd a villanyszerelős szavakat!",
  ...
  },
  {
    id: "de_kosm_1",
    title: "Kozmetika Alapok 1.",
    description: "Alapvető kifejezések manikűrösként vagy kozmetikusként Németországban.",
    industry: "Kozmetika (Kosmetik)",
    xpReward: 15,
    isPro: true,
    lang: "de-DE",
    questions: [
      { id: "de_kosm_q1", type: "flashcard", prompt: "Manikűr", backText: "Maniküre", phonetic: "Má-ní-kü-re" },
      { id: "de_kosm_q2", type: "flashcard", prompt: "Körömlakk", backText: "Nagellack", phonetic: "Ná-gel-lak" },
      {
        id: "de_kosm_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Gesichtsbehandlung'?",
      ...
      { id: "de_kosm_q4", type: "flashcard", prompt: "Milyen színt szeretne?", backText: "Welche Farbe möchten Sie?", phonetic: "Vel-he fár-be möh-ten zí?" },
      {
        id: "de_kosm_q5",
        type: "match",
        prompt: "Párosítsd a kozmetikai szavakat!",
  ...
  },
  {
    id: "de_instal_1",
    title: "Vízvezeték-szerelő Alapok 1.",
    description: "Alapvető kifejezések vízvezeték-szerelőként Németországban.",
    industry: "Vízvezeték-szerelés (Installateur)",
    xpReward: 15,
    isPro: true,
    lang: "de-DE",
    questions: [
      { id: "de_instal_q1", type: "flashcard", prompt: "Csap", backText: "Wasserhahn", phonetic: "Vász-szer-hán" },
      { id: "de_instal_q2", type: "flashcard", prompt: "Cső", backText: "Rohr", phonetic: "Rór" },
      {
        id: "de_instal_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Verstopfung'?",
      ...
      { id: "de_instal_q4", type: "flashcard", prompt: "Honnan szivárog a víz?", backText: "Wo läuft das Wasser aus?", phonetic: "Vó lőft dász vász-szer áusz?" },
      {
        id: "de_instal_q5",
        type: "match",
        prompt: "Párosítsd a szerelős szavakat!",
...
export const INDUSTRY_LESSONS_NL: Lesson[] = [
  ...
  },
  {
    id: "nl_bouw_2",
    title: "Építőipari Alapok 2.",
    description: "Munkavédelem és anyagok — mélyebb szókincs a holland építkezésen.",
    industry: "Építőipar (Bouw)",
    xpReward: 20,
    isPro: true,
    lang: "nl-NL",
    questions: [
      { id: "nl_bouw2_q1", type: "flashcard", prompt: "Sisak", backText: "Helm", phonetic: "Helm" },
      { id: "nl_bouw2_q2", type: "flashcard", prompt: "Állvány", backText: "Steiger", phonetic: "Sztáj-her" },
      {
        id: "nl_bouw2_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Beton'?",
      ...
      { id: "nl_bouw2_q4", type: "flashcard", prompt: "Kérek egy zsák cementet.", backText: "Ik heb een zak cement nodig.", phonetic: "Ik heb en zak ce-ment nó-dih." },
      {
        id: "nl_bouw2_q5",
        type: "match",
        prompt: "Párosítsd az anyagokat és felszereléseket!",
        pairs: [
          { id: "p1", left: "Tégla", right: "Baksteen" },
          { id: "p2", left: "Vakolat", right: "Pleisterwerk" },
          { id: "p3", left: "Munkavédelmi cipő", right: "Veiligheidsschoenen" },
          { id: "p4", left: "Betonkeverő", right: "Betonmolen" },
        ],
      },
    ],
  },
  ...
  },
  {
    id: "nl_horeca_2",
    title: "Vendéglátás Alapok 2.",
    description: "Allergiák, különleges kérések — mélyebb szókincs a holland vendéglátásban.",
    industry: "Vendéglátás (Horeca)",
    xpReward: 20,
    isPro: true,
    lang: "nl-NL",
    questions: [
      { id: "nl_hor2_q1", type: "flashcard", prompt: "Allergia", backText: "Allergie", phonetic: "Á-ler-hí" },
      { id: "nl_hor2_q2", type: "flashcard", prompt: "Vegetáriánus", backText: "Vegetarisch", phonetic: "Fé-he-tá-ris" },
      {
        id: "nl_hor2_q3",
        type: "multiple_choice",
      ...
      { id: "nl_hor2_q4", type: "flashcard", prompt: "Van gluténmentes opció?", backText: "Is er iets glutenvrij?", phonetic: "Isz er ítsz hlu-ten-frej?" },
      {
        id: "nl_hor2_q5",
        type: "match",
        prompt: "Párosítsd a vendéglátós szavakat!",
        pairs: [
          { id: "p1", left: "Panasz", right: "Klacht" },
          { id: "p2", left: "Külön számla", right: "Aparte rekening" },
          { id: "p3", left: "Vegán", right: "Veganistisch" },
          { id: "p4", left: "Adag", right: "Portie" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    lang: "nl-NL",
    questions: [
      { id: "nl_zorg2_q1", type: "flashcard", prompt: "Vérnyomás", backText: "Bloeddruk", phonetic: "Blúd-druk" },
      { id: "nl_zorg2_q2", type: "flashcard", prompt: "Hőmérséklet", backText: "Temperatuur", phonetic: "Tem-pe-rá-túr" },
      {
        id: "nl_zorg2_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Medicijnschema'?",
        options: [
          { id: "a", text: "Gyógyszeradagolási terv" },
          { id: "b", text: "Étrend" },
          { id: "c", text: "Kórtörténet" },
      ...
      { id: "nl_zorg2_q4", type: "flashcard", prompt: "Segítek felkelni.", backText: "Ik help u opstaan.", phonetic: "Ik help ü op-stán." },
      {
        id: "nl_zorg2_q5",
        type: "match",
        prompt: "Párosítsd az ápolási szavakat!",
        pairs: [
          { id: "p1", left: "Testápolás", right: "Lichaamsverzorging" },
          { id: "p2", left: "Ágytál", right: "Ondersteek" },
          { id: "p3", left: "Vérnyomásmérő", right: "Bloeddrukmeter" },
          { id: "p4", left: "Kórterem", right: "Ziekenkamer" },
        ],
      },
    ],
  },
  ...
  },
  {
    id: "nl_bakkerij_1",
    title: "Pékség Alapok 1.",
    description: "Alapvető kifejezések egy holland pékségben.",
    industry: "Élelmiszeripar (Bakkerij)",
    xpReward: 15,
    isPro: true,
    lang: "nl-NL",
    questions: [
      { id: "nl_bakkerij_q1", type: "flashcard", prompt: "Tészta", backText: "Deeg", phonetic: "Déh" },
      { id: "nl_bakkerij_q2", type: "flashcard", prompt: "Zsemle", backText: "Broodje", phonetic: "Brót-je" },
      {
        id: "nl_bakkerij_q3",
        type: "multiple_choice",
        prompt: "Mit jelent az 'Oven'?",
        options: [
          { id: "a", text: "Sütő" },
          { id: "b", text: "Liszt" },
          { id: "c", text: "Tészta" },
      ...
      { id: "nl_bakkerij_q4", type: "flashcard", prompt: "Friss még meleg a kenyér?", backText: "Is het brood nog vers/warm?", phonetic: "Isz het brót noh versz/várm?" },
      {
        id: "nl_bakkerij_q5",
        type: "match",
        prompt: "Párosítsd a pékségi szavakat!",
        pairs: [
          { id: "p1", left: "Kenyér", right: "Brood" },
          { id: "p2", left: "Liszt", right: "Meel" },
          { id: "p3", left: "Croissant", right: "Croissant" },
          { id: "p4", left: "Süteménytészta", right: "Gebaksdeeg" },
        ],
      },
    ],
  },
  {
    id: "nl_elektricien_1",
    title: "Villanyszerelő Alapok 1.",
    description: "Alapvető kifejezések villanyszerelőként Hollandiában.",
    industry: "Villanyszerelés (Elektricien)",
    xpReward: 15,
    isPro: true,
    lang: "nl-NL",
    questions: [
      { id: "nl_elektricien_q1", type: "flashcard", prompt: "Kábel", backText: "Kabel", phonetic: "Ká-bel" },
      { id: "nl_elektricien_q2", type: "flashcard", prompt: "Biztosíték", backText: "Zekering", phonetic: "Zé-ke-ring" },
      {
        id: "nl_elektricien_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Stopcontact'?",
        options: [
          { id: "a", text: "Konnektor" },
          { id: "b", text: "Kábel" },
          { id: "c", text: "Biztosíték" },
      ...
      { id: "nl_elektricien_q4", type: "flashcard", prompt: "Kapcsold le az áramot!", backText: "Zet de stroom uit!", phonetic: "Zet de sztróm öit!" },
      {
        id: "nl_elektricien_q5",
        type: "match",
        prompt: "Párosítsd a villanyszerelős szavakat!",
        pairs: [
          { id: "p1", left: "Áramütés", right: "Elektrische schok" },
          { id: "p2", left: "Szerelés", right: "Installatie" },
          { id: "p3", left: "Villanyszerelő", right: "Elektricien" },
          { id: "p4", left: "Kapcsoló", right: "Schakelaar" },
        ],
      },
    ],
  },
  {
    id: "nl_kosmetica_1",
    title: "Kozmetika Alapok 1.",
    description: "Alapvető kifejezések manikűrösként vagy kozmetikusként Hollandiában.",
    industry: "Kozmetika (Schoonheidsspecialiste)",
    xpReward: 15,
    isPro: true,
    lang: "nl-NL",
    questions: [
      { id: "nl_kosmetica_q1", type: "flashcard", prompt: "Manikűr", backText: "Manicure", phonetic: "Má-ní-kü-re" },
      { id: "nl_kosmetica_q2", type: "flashcard", prompt: "Körömlakk", backText: "Nagellak", phonetic: "Ná-hel-lak" },
      {
        id: "nl_kosmetica_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Gezichtsbehandeling'?",
        options: [
          { id: "a", text: "Arckezelés" },
          { id: "b", text: "Szemöldökszedés" },
          { id: "c", text: "Pedikűr" },
      ...
      { id: "nl_kosmetica_q4", type: "flashcard", prompt: "Milyen színt szeretne?", backText: "Welke kleur wilt u?", phonetic: "Vel-ke klőr vilt ü?" },
      {
        id: "nl_kosmetica_q5",
        type: "match",
        prompt: "Párosítsd a kozmetikai szavakat!",
        pairs: [
          { id: "p1", left: "Műköröm", right: "Kunstnagels" },
          { id: "p2", left: "Szemöldökszedés", right: "Wenkbrauwen epileren" },
          { id: "p3", left: "Pedikűr", right: "Pedicure" },
          { id: "p4", left: "Szempillafestés", right: "Wimpers verven" },
        ],
      },
    ],
  },
  {
    id: "nl_loodgieter_1",
    title: "Vízvezeték-szerelő Alapok 1.",
    description: "Alapvető kifejezések vízvezeték-szerelőként Hollandiában.",
    industry: "Vízvezeték-szerelés (Loodgieter)",
    xpReward: 15,
    isPro: true,
    lang: "nl-NL",
    questions: [
      { id: "nl_loodgieter_q1", type: "flashcard", prompt: "Csap", backText: "Kraan", phonetic: "Krán" },
      { id: "nl_loodgieter_q2", type: "flashcard", prompt: "Cső", backText: "Leiding", phonetic: "Léj-ding" },
      {
        id: "nl_loodgieter_q3",
        type: "multiple_choice",
        prompt: "Mit jelent a 'Verstopping'?",
        options: [
          { id: "a", text: "Dugulás" },
          { id: "b", text: "Szivárgás" },
          { id: "c", text: "Fűtés" },
      ...
      { id: "nl_loodgieter_q4", type: "flashcard", prompt: "Honnan szivárog a víz?", backText: "Waar lekt het water uit?", phonetic: "Vár lekt het vá-ter öit?" },
      {
        id: "nl_loodgieter_q5",
        type: "match",
        prompt: "Párosítsd a szerelős szavakat!",
        pairs: [
          { id: "p1", left: "Szivárgás", right: "Lekkage" },
          { id: "p2", left: "Fűtés", right: "Verwarming" },
          { id: "p3", left: "Vízóra", right: "Watermeter" },
          { id: "p4", left: "Lefolyó", right: "Afvoer" },
        ],
      },
    ],
  },
