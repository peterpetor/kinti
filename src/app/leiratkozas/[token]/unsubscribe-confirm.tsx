...
/**
 * Hírlevél-leiratkozás megerősítő UI (kliens). A tényleges törlés a „Leiratkozom"
 * gombbal, POST-tal történik — így a prefetcherek/szkennerek nem iratkoztatnak le
 * senkit véletlenül. A szülő `page.tsx` szerver-komponens (edge runtime).
 */
