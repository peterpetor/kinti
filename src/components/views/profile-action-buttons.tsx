...
export function ProfileShareButton({ businessName }: { businessName: string }) {
  const [toastMessage, setToastMessage] = useState<string | null>(null);
  ...
  return (
    <>
      <button
        ...
        onClick={handleShare}
        aria-label="Megosztás"
        className="grid h-[46px] w-[50px] place-items-center rounded-[14px] bg-surface text-ink shadow-[inset_0_0_0_1px_rgb(var(--border-channel)/var(--border-strong-alpha))] hover:bg-surface-alt active:scale-[0.97] transition-all"
      >
