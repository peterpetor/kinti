...
const inputCls =
  "w-full rounded-[12px] border border-line bg-surface px-3 py-2.5 text-[14px] text-ink placeholder:text-ink-faint focus:outline-none focus:ring-2 focus:ring-star/30";
