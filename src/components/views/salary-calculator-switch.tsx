...
import { SalaryCalculatorES } from "@/components/views/salary-calculator-es";
 ...
 * ES = spanyol (IRPF + Seguridad Social, 12/14 paga).
...
export function SalaryCalculatorSwitch() {
  ...
  if (country === "ES") return <SalaryCalculatorES />;
