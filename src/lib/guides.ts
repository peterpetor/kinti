...
export const GUIDES_GB: Guide[] = [
  {
    ...
    sections: [
      ...
      { heading: "Állampolgárság (naturalisation)", body: ["A fő szabály két feltétel EGYÜTT: legalább 5 év jogszerű tartózkodás az Egyesült Királyságban, ÉS a kérelem benyújtásakor már legalább 12 hónapja letelepedett státusz (settled status / indefinite leave to remain). Mivel a letelepedett státusz maga is jellemzően 5 év után jár, a gyakorlatban ez összesen 6 év — ezért a listákban 6 évvel számolunk.", "Brit állampolgár házastársaként rövidebb: 3 év tartózkodás elég, és nem kell megvárni a letelepedett státusz utáni 12 hónapot — de a letelepedett státusszal a kérelemkor már rendelkezni kell.", "Távollét-korlát: az 5 év alatt legfeljebb 450 nap, az utolsó 12 hónapban legfeljebb 90 nap tölthető külföldön.", "Nyelvi és ismereti feltétel: angol (vagy walesi/skót gael) nyelvtudás B1 szinten, plusz a „Life in the UK\" teszt sikeres letétele.", "⚠️ Kettős állampolgárság: az Egyesült Királyság ENGEDÉLYEZI — a magyar állampolgárságodról NEM kell lemondanod. (Ez lényeges különbség Ausztriához képest.)"] },
      { heading: "⚠️ Nincs lakcím-bejelentkezés", body: ["Angliában NINCS a magyar (vagy német/osztrák) lakcímbejelentéshez hasonló kötelező lakónyilvántartás — nem kell hivatalba menni bejelentkezni, és nincs is „lakcímkártya\".", "A gyakorlatban ezt a szerepet a címhez kötött nyomok töltik be: GP-regisztráció, council tax-számla, bankszámla, választói névjegyzék (electoral register). Lakcímigazolásként (proof of address) jellemzően ezeket kérik — érdemes az elsők között elintézni őket."] },
    ],
    sources: [
      ...
      { label: "gov.uk — Apply for citizenship by naturalisation", url: "https://www.gov.uk/apply-citizenship-indefinite-leave-to-remain" },
      { label: "gov.uk — Dual citizenship", url: "https://www.gov.uk/dual-citizenship" },
    ],
  },
  {
    slug: "gb-nin",
