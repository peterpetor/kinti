...
export const APP_DESTINATIONS: readonly AppDestination[] = [
  ...
  { href: "/angol-oneletrajz", title: "Angol önéletrajz készítő", subtitle: "Ingyenes brit CV PDF magyar → angol szakmanévvel", icon: "document",
    feature: "angol-oneletrajz",
    keywords: "onéletrajz oneletrajz cv angol english brit uk anglia pdf allas munka jelentkezes szakma forditas resume" },
  { href: "/spanyol-oneletrajz", title: "Spanyol önéletrajz készítő", subtitle: "Ingyenes spanyol CV PDF magyar → spanyol szakmanévvel", icon: "document",
    feature: "spanyol-oneletrajz",
    keywords: "onéletrajz oneletrajz cv spanyol espanol curriculum vitae spanyolorszag pdf allas munka jelentkezes szakma forditas" },
