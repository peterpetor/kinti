/** Az app-szintű alapértelmezett megosztó-kép (1200x630, márkás). SVG -> PNG sharp-pal. */
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <g transform="translate(537,58) scale(2.5)">
  ...
  <text x="600" y="375" text-anchor="middle" font-family="Georgia, 'Times New Roman', serif" font-size="118" font-weight="bold" fill="#1d4434" letter-spacing="-2">kinti</text>
  <text x="600" y="438" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="37" fill="#5c6d63">Találj magyart a közeledben</text>
  <text x="600" y="556" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="27" font-weight="bold" fill="#1d4434" letter-spacing="1">SVÁJC · AUSZTRIA · NÉMETORSZÁG</text>
</svg>`;
sharp(Buffer.from(svg)).png().toFile('public/icons/og-default.png')
  .then(i => console.log('written og-default.png', i.width + 'x' + i.height, i.size + ' bytes'))
