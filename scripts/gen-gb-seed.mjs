...
const VALID_CATEGORIES = new Set(["magyar-kozosseg", "elelmiszer", "etterem", "cukrasz", "konyveles", "fogorvos", "fodrasz", "szepseg", "ugyved", "pszichologus", "fordito", "penzugyi_tanacsado", "jogtanacsado"]);
const problems = [];
